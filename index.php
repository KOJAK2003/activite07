                   ...
                   <?php foreach ($items as $key=>$value) : ?>
                    <tr>
                     ...
                     <td>
                         ...
                         <a href="<?php echo 'update.php?id='.$value['id']; ?>" type="submit" class="btn btn-primary">Finished</a>
                         <a href="<?php echo 'delete.php?id='.$value['id']; ?>" type="submit" class="btn btn-danger">X</a>
                     </td>
                   </tr>
                   <?php endforeach; ?>
              </tbody>
